...
The first step in the extraction is the detection of component boundaries which separate components as single entities from the point of view of the system's architect \cite{Brosig2011}.
