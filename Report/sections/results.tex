...
\\ \\
\textbf{Approach.}
% TODO: Is this only the explanation of how MiSAR was developed?
...
% Brosig %
%%%%%%%%%%
% TODO: Change to "Approach by Brosig et al."?
% TODO: Then => remove cites from all headings
...
After the system boundaries have been determined, the running system is monitored using \textit{call path tracing} \todo{Explain} \cite{Brosig2011}.
...
% TODO: Problem, because unused components will not be part of architecture model and therefore cannot be identified as unused
